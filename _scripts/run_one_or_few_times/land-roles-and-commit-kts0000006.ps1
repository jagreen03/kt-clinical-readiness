...
$rolesPath = Join-Path $vault "05_Wiki\Triad\roles.md"
...
Set-Content -Path $rolesPath -Value $rolesContent -Encoding UTF8

Set-Location $vault

git add -A
git commit -m "KTS-0000006: BFF architectural baseline + Triad roles doctrine"
git push
